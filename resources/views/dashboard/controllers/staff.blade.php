        ...
        <div class="block-heading-two">
            <h4>
                ...
                @else
                    ...
                    @endforeach
                @endif
                &nbsp;<a href="{{ 'mailto:ata@'.\Config::get('facility.email') }}" style="color:black"><i class="fa fa-envelope" ></i></a>
            </h4>
        </div>
        <hr>
    @endif
        ...
        <div class="block-heading-two">
            <h4>
                ...
                @else
                    ...
                    @endforeach
                @endif
                &nbsp;<a href="{{ 'mailto:awm@'.\Config::get('facility.email') }}" style="color:black"><i class="fa fa-envelope" ></i></a>
            </h4>
        </div>
        <hr>
    @endif
        ...
        <div class="block-heading-two">
            <h4>
                ...
                @else
                    ...
                    @endforeach
                @endif
                &nbsp;<a href="{{ 'mailto:aec@'.\Config::get('facility.email') }}" style="color:black"><i class="fa fa-envelope" ></i></a>
            </h4>
        </div>
        <hr>
    @endif
        ...
        <div class="block-heading-two">
            <h4>
                ...
                @else
                    ...
                    @endforeach
                @endif
                &nbsp;<a href="{{ 'mailto:afe@'.\Config::get('facility.email') }}" style="color:black"><i class="fa fa-envelope" ></i></a>
            </h4>
        </div>
        <hr>
    @endif
