        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    {!! Form::text('from', 'info@'.\Config::get('facility.email'), ['disabled', 'class' => 'form-control']) !!}
                </div>
            </div>
            <div class="col-sm-4">
                <div class="form-group">
            ...
            <div class="col-sm-4">
                ...
                {!! Form::text('reply_to', null, ['placeholder' => 'ex. info@'.\Config::get('facility.email').' (Required)', 'class' => 'form-control']) !!}
            </div>
        </div>
        <div class="row">
            <div class="col-sm-6">
